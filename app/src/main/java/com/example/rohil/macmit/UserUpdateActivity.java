...
public class UserUpdateActivity extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener {
    ...
    private static String url_update = "http://127.0.0.1:8000/project1/v1/update";
    ...
    private void attemptLogin() {
        ...
        if (isMapClicked == false){
            Toast.makeText(UserUpdateActivity.this, "Please choose your address on the map", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (cancel) {
            ...
            // perform the user login attempt.
            showProgress(true);
            mAuthTask = new UserUpdateTask(mSelectedCoordinates, Email, Pass, Name, Phone, Address);
    ...
    public class UserUpdateTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserUpdateTask(LatLng latLng, String email, String pass, String name, String phone, String address) {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Context context = UserUpdateActivity.this;
            SharedPreferences sharedPref = context.getSharedPreferences(
                    getString(R.string.preference_file_key_user), Context.MODE_PRIVATE);
            // getting JSON string from URL

            JSONObject json = jsonParser.makeHttpRequest(url_update, "POST", param, sharedPref.getString("uid", "000") );
        ...
        protected void onPostExecute(final Boolean success) {
            showProgress(false);
           // Toast.makeText(UserUpdateActivity.this, json.toString(), Toast.LENGTH_SHORT).show();
            if (success) {
